...
| 019 | [Migrate attention to per-trial DB schema](./019-attention-per-trial.md) | DONE | Medium | — |
| 020 | [Migrate nback-stream to per-trial DB schema](./020-nback-per-trial.md) | DONE | Medium | — |
