...
<main
	class="flex max-h-screen w-full max-w-md flex-col items-center gap-6 overflow-y-auto p-4 pb-28 text-white"
>
	<h1 class="text-2xl font-bold">🧪 Доступные тесты</h1>
