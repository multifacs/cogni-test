...
<main class="main overflow-auto p-4">
	<div class="flex flex-col gap-6">
		...
		<div class="flex flex-col gap-3 rounded-xl border border-gray-700 bg-white p-4">
			<h2 class="text-center text-lg font-semibold">Сгенерировать случайные сеты</h2>
			{#if generateError}
		...
		<!-- Create manually -->
		<div class="flex flex-col gap-3 rounded-xl border border-gray-700 bg-white p-4">
			<h2 class="text-center text-lg font-semibold">Создать сет вручную</h2>
			{#if createError}
		...
		<div class="flex flex-col gap-3">
			<div class="flex items-center gap-3">
				<h2 class="text-center text-lg font-semibold">Существующие сеты</h2>
...
<section class="low-content flex items-center justify-center gap-3">
	...
	<Button color="purple" goto="/admin/gto">Сессии ГТО-М</Button>
</section>
