...
export const campimetryAttempt = sqliteTable('campimetry_attempt', {
...
export const mathAttempt = sqliteTable('math_attempt', {
    id: text('id').primaryKey().$defaultFn(short.generate),
    attempt: integer('attempt').notNull(),
    stage: integer('stage').notNull(),
    time: integer('time').notNull(),
    ...
    check("sign_check", enumCheck(table.sign, [">", "<", ">=", "<=", "=", "!="]))
]);
...
export const stroopAttempt = sqliteTable('stroop_attempt', {
    id: text('id')
        .primaryKey()
        .notNull()
        .$defaultFn(short.generate),
    ...
    check("color_check", enumCheck(table.color, ['red', 'blue', 'green', 'cyan', 'magenta', 'yellow'])),
...
export const swallowAttempt = sqliteTable('swallow_attempt', {
