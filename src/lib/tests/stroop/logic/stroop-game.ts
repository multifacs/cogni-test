...
export class StroopGame {
	...
	private generateTasks(): void {
		...
		this.tasks.push({ stage: 0, word: 'stage 1', color: 'var(--main-text-color)', task: 'stage' } as Task);
		...
		this.tasks.push({ stage: 0, word: 'stage 2', color: 'var(--main-text-color)', task: 'stage' } as Task);
		...
		this.tasks.push({ stage: 0, word: 'stage 3', color: 'var(--main-text-color)', task: 'stage' } as Task);
