<script lang="ts">
	...
	function getResults(testType: 'stroop', results: StroopResult[]): Result[] {
		console.log(results);
					...
					legend: {
						labels: {
							...
							generateLabels: (chart) => {
								...
								original[0].pointStyle = 'line';
								original[0].text = 'По цвету и смыслу';
								original[1].pointStyle = 'line';
								original[1].text = 'По смыслу';
								original[2].pointStyle = 'line';
								original[2].text = 'По цвету';
								original.push(
									{
